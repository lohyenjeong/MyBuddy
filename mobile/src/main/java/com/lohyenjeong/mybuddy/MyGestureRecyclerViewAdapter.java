...
import com.lohyenjeong.mybuddy.ItemFragment.OnListFragmentInteractionListener;
...
public class MyGestureRecyclerViewAdapter extends RecyclerView.Adapter<MyGestureRecyclerViewAdapter.ViewHolder> {
    ...
    public MyGestureRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
